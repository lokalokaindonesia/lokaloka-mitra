    ...
    <Layout>
      ...
      <div className="flex flex-col space-y-2">
        ...
        {transactions.length == 0 && (
          <div className="w-full text-lg text-center border border-dashed border-blueGray-100 p-8 rounded h-full font-bold">
            No Order
          </div>
        )}
        {transactions.map((t, i) => {
          return (
            <div
              key={i}
              className="w-full bg-blueGray-900 shadow-sm text-xs p-2 rounded"
            >
              <div className="grid grid-flow-row grid-cols-5 gap-4 px-8 py-4">
                ...
                <div className="flex flex-col justify-start space-y-2 max-w-md">
                  ...
                  <span className="font-bold capitalize text-md text-blueGray-100 line-clamp-2">
                    {t.shippingLocation}
                  </span>
                </div>
                <div className="flex flex-col justify-start space-y-2 max-w-md">
                ...
                <div className="flex flex-col justify-start space-y-2">
                  ...
                  <span className="font-bold uppercase text-md text-blueGray-100">
                    {t.code}
                  </span>
                </div>
              </div>
              <div className="py-6 px-8 flex flex-col space-y-2 border-t border-blueGray-500">
                <div className="w-full">
                  <span className="text-xl font-bold text-blueGray-200">
